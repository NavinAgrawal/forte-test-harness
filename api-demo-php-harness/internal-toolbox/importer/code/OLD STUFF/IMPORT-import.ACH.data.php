...
array_map("unlink", glob("../../../toolbox1/importer/failure.ACH.data.csv"));
array_map("unlink", glob("../../../toolbox1/importer/failure.ACH.log.txt"));
...
if ($handle = fopen("../../../toolbox1/importer/data.csv", "r")) {
	while ($fields = fgetcsv($handle, 1000, ",")) {
		...
		if (!file_exists('../../../toolbox1/importer/failure.ACH.log.txt')) {
			$fail_log = fopen("../../../toolbox1/importer/failure.ACH.log.txt", "a+");
			fwrite($fail_log,"
////////////////////////////////////////////////////////////////
//////////////////                         /////////////////////
//////////////////   A C H   E R R O R S   /////////////////////
...
");
		...
		$fail_data = fopen("../../../toolbox1/importer/failure.ACH.data.csv", "a+");
