...
if (!file_exists("../../../toolbox1/importer/failure.ACH.data.csv")) {
...
if ($handle = fopen("../../../toolbox1/importer/failure.ACH.data.csv", "r")) {
	while ($fields = fgetcsv($handle, 1000, ",")) {
		...
		if (!file_exists('../../../toolbox1/importer/failure.log2.ACH.txt')) {
			$fail_log = fopen("../../../toolbox1/importer/failure.log2.ACH.txt", "a+");
			fwrite($fail_log, "
////////////////////////////////////////////////////////////////
///////////////////                         ////////////////////
///////////////////   A C H   E R R O R S   ////////////////////
...
");
		...
		$fail_data = fopen("../../../toolbox1/importer/failure.data2.ACH.csv", "a+");
...
fclose($fail_data);
fclose($fail_log);
unlink("../../../toolbox1/importer/failure.ACH.data.csv");
unlink("../../../toolbox1/importer/failure.ACH.log.txt");
rename("../../../toolbox1/importer/failure.data2.ACH.csv","../../../toolbox1/importer/failure.ACH.data.csv");
rename("../../../toolbox1/importer/failure.log2.ACH.txt","../../../toolbox1/importer/failure.ACH.log.txt");
?>