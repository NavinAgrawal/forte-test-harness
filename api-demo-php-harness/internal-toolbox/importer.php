        ...
        <div id="content">
          <div class="splitleft">
            ...
            <table border="0" cellpadding="1" cellspacing="0">
              ...
              <tr>
                <td>
                  <a class="link" target="_blank" style="font-size:13pt" href="code/importer.directions.php">
                  How to Use the Importer tool</a>
                </td>
              </tr>
              <tr>
                <td><img border="0" src="images/spacer.gif" width="20" height="15"></td>
            ...
            <center>
              ...
              <div align="center" style="width:85%; background-color:#F9F9F9; padding:10px 0px 10px 0px; border-style:solid; border-width:thick; border-color:gray;">
                ...
                <BR>
                <form align="center" style="margin-left:20px; text-align:center;" action="../IMPORT-upload.php" method="post" enctype="multipart/form-data">
                ...
                <form align="center" style="text-align:center;" action="../internal-toolbox/importer/code/splitter.php" method="post">
                  ...
                  <input class="button6" type="submit" value="Data Splitter" name="Splitter"></p>
                </form>
                  ...
                  <div style="margin-left:60px">
                    <table align="left" class border="0" cellpadding="2" cellspacing="1">
                      ...
                      <tr>
                        ...
                        <td>&nbsp;</td>
                        <td align="right">
                          <button class="button6" type="reset" value="reset">Clear the fields</button>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-left:100px;text-align:left">
                    <table border="0" cellpadding="1" cellspacing="0" width="100%">
                      ...
                      <tr>
                        ...
                        <tr>
                        <td>
                        <button class="button2" type="submit" name="ACHschedules" value="ACHschedules">
                        Import ACH Schedules</button>&nbsp;
                        <button class="button2" type="submit" name="ACHcustFails" value="ACHcustFails">
                        ACH Fails Customers</button>&nbsp;
                        <button class="button2" type="submit" name="ACHschedFails" value="ACHschedFails">
			...
			<img border="0" src="images/spacer.gif" width="20" height="50">
            </form>
          </div>
          <!-- Begin Page Menu  -->
