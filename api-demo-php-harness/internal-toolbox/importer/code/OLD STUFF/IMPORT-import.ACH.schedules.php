...
array_map("unlink", glob("../../../internal-toolbox/importer/failure.ACH.customer.data.csv"));
array_map("unlink", glob("../../../internal-toolbox/importer/failure.ACH.customer.log.txt"));
array_map("unlink", glob("../../../internal-toolbox/importer/failure.ACH.schedule.data.csv"));
array_map("unlink", glob("../../../internal-toolbox/importer/failure.ACH.schedule.log.txt"));
...
if ($handle = fopen("../../../internal-toolbox/importer/data.csv", "r")) {
	while ($fields = fgetcsv($handle)) {
		...
		if (!file_exists('../../../internal-toolbox/importer/failure.ACH.customer.log.txt')) {
			$fail_custLog = fopen("../../../internal-toolbox/importer/failure.ACH.customer.log.txt", "a+");
			fwrite($fail_custLog, "
////////////////////////////////////////////////////////////////
//////////                                           ///////////
...
");
		...
		$fail_custData = fopen("../../../internal-toolbox/importer/failure.ACH.customer.data.csv", "a+");
		...
		if($info['http_code']==201) {
			...
			//if the failure log does not exist, create it and write the header
			if (!file_exists('../../../internal-toolbox/importer/failure.ACH.schedule.log.txt')) {
