...
$fail_custLog = fopen("../../../internal-toolbox/importer/failure.log2.cust-ACH.txt", "a+");
fwrite($fail_custLog, "
////////////////////////////////////////////////////////////////
//////////                                           ///////////
...
if ($handle = fopen("../../../internal-toolbox/importer/failure.ACH.customer.data.csv", "r")) {
	while ($fields = fgetcsv($handle)) {
		...
		$accountholder    = $fields[11];
		$routing_number   = $fields[12];
		$account_number   = $fields[13];
		$account_type     = $fields[14];
		$sched_quantity   = $fields[15];
		$frequency        = $fields[16];
		$sched_amount     = $fields[17];
		$sched_start_date = $fields[18];
		...
		$fail_custData = fopen("../../../internal-toolbox/importer/failure.data2.cust-ACH.csv", "a+");
		...
		if($info['http_code']==201) {
			...
			//if the failure log exists, create log2 and write the header
			$fail_schedLog = fopen("../../../internal-toolbox/importer/failure.ACH.schedule.log.txt", "a+");			
			$fail_schedData = fopen("../../../internal-toolbox/importer/failure.ACH.schedule.data.csv", "a+");
			
			$sched_data = array($cust_token,$pay_token,$sched_quantity,$frequency,$sched_amount,$sched_start_date);			

			$fp = file('../../../internal-toolbox/importer/failure.ACH.schedule.data.csv');
			$error_no2 = count($fp);
...
rename("../../../internal-toolbox/importer/failure.data2.cust-ACH.csv","../../../internal-toolbox/importer/failure.ACH.customer.data.csv");
rename("../../../internal-toolbox/importer/failure.log2.cust-ACH.txt","../../../internal-toolbox/importer/failure.ACH.customer.log.txt");
//rename("../../../internal-toolbox/importer/failure.data2.sched-ACH.csv","../../../internal-toolbox/importer/failure.ACH.schedule.data.csv");
//rename("../../../internal-toolbox/importer/failure.log2.sched-ACH.txt","../../../internal-toolbox/importer/failure.ACH.schedule.log.txt");
?>