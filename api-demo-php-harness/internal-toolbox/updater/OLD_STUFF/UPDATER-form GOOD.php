		...
		<td>
			...
			<center>
				...
				<table border="0" cellpadding="1" cellspacing="0">
					...
					<tr><td align="right"><font style="font-size: 12pt">Organization ID:&nbsp;</font></td><td><input type="text" name="organization_id" style="color: #919191; padding-left:3; width:250px;">&nbsp;&nbsp;</td></tr>
					<tr><td align="right"><font style="font-size: 12pt">Location ID:&nbsp;</font></td><td><input type="text" name="location_id" style="color: #919191; padding-left:3; width:250px;">&nbsp;&nbsp;</td></tr>
					<tr><td align="right"><font style="font-size: 12pt">API Access ID:&nbsp;</font></td><td><input type="text" name="api_access_id" style="color: #919191; padding-left:3; width:250px;">&nbsp;&nbsp;</td></tr>
					<tr><td align="right"><font style="font-size: 12pt">API Secure Key:&nbsp;</font></td><td><input type="text" name="api_secure_key" style="color: #919191; padding-left:3; width:250px;">&nbsp;&nbsp;</td></tr>
				</table>
				<table border="0" cellspacing="0" width="360">
					<tr><td align="right"><span style="font-size: 8pt">&nbsp;</span></td></tr>
					<tr><td align="right"><p style="font-size:12pt; text-align:justify">This report generator uses REST calls to create a list of all the credit card updates made by Forte's Account Updater service during the selected date range.</td></tr>
				...
				<table>
					...
					<tr><td align="center"><font style="font-size: 4pt">&nbsp;</font></td></tr>
				</table>
				<!-- table width="400" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr><td align="center"><font style="font-size: 6pt">&nbsp;</font></td></tr>
					<tr><td align="center"><a href="https://www.forte.net"><img border="0" align="center" src="images/forte.logo.png" width="114" height="39"></a></td></tr>
				</table -->
			</center>
			</td>
			</tr>
