...
$totalamount = "0.05";
//$cust_token = 'ikQi91n8a0SiQdOBdlq5ZQ';
//$pay_token = '12947070';
$method = 'token';  //can be token, auth, sale or schedule
$version = '2.0';
...
<style>
body {
	background-image: url('fairway03.png');
...
<center>
<!--img src="fairway03.jpg" alt="Italian Trulli" -->
...
<button class="bluebutton"
	...
	<!--script type="text/javascript">
      function onTokenCreated(response) {
		...
		window.location.href = "REST-onetime.to.transaction.php?ott=" + "cst_"ott + "&type=" + type + "&name_on_card=" + name; 
      }
   </script -->
