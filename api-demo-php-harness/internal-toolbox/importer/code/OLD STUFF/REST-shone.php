...
$filename    = 'EXPORT.ALL.CUSTOMERS--MID.'.$merchant_id.'--'.date("Y.m.d").'.csv';
...
$headers = '"Merchant ID","Customer Token","Paymethod Token","Consumer ID","Status","First Name","Last Name","Company Name","Address 1","Address 2",City,State,Zipcode,Phone,Email,"Cardholder Name","Last 4","Card Type","Expire Mo","Expire Yr","Account Holder","Account Type","Routing No","Last 4","Created On"'.PHP_EOL;
