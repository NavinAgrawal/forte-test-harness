...
array_map("unlink", glob("../../../internal-toolbox/importer/failure.CC.customer.data.csv"));
array_map("unlink", glob("../../../internal-toolbox/importer/failure.CC.customer.log.txt"));
array_map("unlink", glob("../../../internal-toolbox/importer/failure.CC.schedule.data.csv"));
array_map("unlink", glob("../../../internal-toolbox/importer/failure.CC.schedule.log.txt"));
...
if ($handle = fopen("../../../internal-toolbox/importer/data.csv", "r")) {
	while ($fields = fgetcsv($handle)) {
		...
		if (!file_exists('../../../internal-toolbox/importer/failure.CC.customer.log.txt')) {
			$fail_custLog = fopen("../../../internal-toolbox/importer/failure.CC.customer.log.txt", "a+");
			fwrite($fail_custLog, "
////////////////////////////////////////////////////////////////
//////////                                           ///////////
...
");
		...
		$fail_custData = fopen("../../../internal-toolbox/importer/failure.CC.customer.data.csv", "a+");
		...
		if($info['http_code']==201) {
			...
			if (!file_exists('../../../internal-toolbox/importer/failure.CC.schedule.log.txt')) {
				$fail_schedLog = fopen("../../../internal-toolbox/importer/failure.CC.schedule.log.txt", "a+");
...
");
			...
			$fail_schedData = fopen("../../../internal-toolbox/importer/failure.CC.schedule.data.csv", "a+");
