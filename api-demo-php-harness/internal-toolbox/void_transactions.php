...
<div id="border">
  <div id="container">
    ...
    <div id="content">
      <div class="splitleft">
        <p><span class="style4">Void Transactions</span></p>
        <p>&nbsp;</p>
        <p>Shone wrote this REST script for voiding transactions. You do a transaction 
		export in Virtual Terminal, and create a csv file with only the transaction ID and 
		authorization code -- in that order.<br><br>
		<form align="left" style="margin-left:70px" action="upload.php" method="post" enctype="multipart/form-data">
			Select csv file to upload:
			<input type="file" name="fileToUpload" id="fileToUpload"><br>
			<p style="margin-left:280px"><input class="button6" type="submit" value="Upload csv file" name="submit"></p>
		</form>
		</p>
        <form class method="POST" action="../internal-toolbox/void_transactions/VOID-void.tx.php">
