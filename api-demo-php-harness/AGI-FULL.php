...
<form method='Post' action='<?php echo htmlspecialchars($pg_action_url, ENT_QUOTES); ?>'>   <!-- production/sandbox via config -->
	...
	<input type='hidden' name='pg_procurement_card' value=''/>
	...
	<input type='hidden' name='ecom_payment_card_name' value='Forte Test'/>
	<input type='hidden' name='ecom_payment_card_number' value='****************'/>
	<input type='hidden' name='ecom_payment_card_expdate_month' value='04'/>
	<input type='hidden' name='ecom_payment_card_expdate_year' value='2032'/>
	<input type='hidden' name='ecom_payment_card_verification' value='456'/>
	...
	<!--input type='hidden' name='pg_line_item_header' value='SIZE,COLOR,STYLE'/>
	<input type='hidden' name='pg_line_item_1' value='6.5M,orange,high-top'/>
	<input type='hidden' name='pg_line_item_2' value='10M,red,high-top'/>
	<input type='hidden' name='pg_line_item_3' value='7.5W,blue,low-top'/>
	<input type='hidden' name='pg_line_item_4' value='12S,green,high-top'/-->
