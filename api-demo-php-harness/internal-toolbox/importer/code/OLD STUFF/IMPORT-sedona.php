...
$filename    = 'SedonaOffice--MID.'.$merchant_id.'--'.date("Y.m.d").'.csv';
...
$headers = '"Customer Number","Paymethod Token","Card Last Four","eCheck Last Four","Routing Number","Bank Name","Is Checking","Cardholder Name","Accountholder Name",Address1,Address2,City,State,Zipcode,"Phone Number",Email,"Recurring Yes/No","Recurring Day (1-28)"'.PHP_EOL;
...
while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
	...
	for ($c=0; $c < $num; $c++) {
		...
		// define the row
		$entries = $customer_id.','.$paymethod_token.','.$cc_last_4.','.$ach_last_4.','.$routing.',,,'.$cardholder.','.$accountholder.','.$address1.','.$address2.','.$city.','.$state.','.$zipcode.','.$phone.','.$email.',,'.PHP_EOL;
