...
$fail_custLog = fopen("../failure.log2.cust-ACH.txt", "a+");
...
$handle = fopen("../failure.ACH.customer.data.csv", "r");
while ($fields = fgetcsv($handle)) {
	...
	$fail_custData = fopen("../failure.data2.cust-ACH.csv", "a+");
	...
	if($info['http_code']==201) {
		...
		$fp = file('../failure.ACH.schedule.data.csv');
		$error_no2 = count($fp);
...
rename("../failure.data2.cust-ACH.csv","../failure.ACH.customer.data.csv");
rename("../failure.log2.cust-ACH.txt","../failure.ACH.customer.log.txt");
