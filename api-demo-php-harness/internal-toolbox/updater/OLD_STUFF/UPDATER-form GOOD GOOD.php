		...
		<td>
			...
			<center>
				<table align="center" border="0" cellpadding="1" cellspacing="0">
					...
					<tr>
					  <td>
						<select size="1" name="s_day" style>
				...
				<table border="0" cellpadding="1" cellspacing="0">
					...
					<tr><td align="right"><font style="font-size: 12pt">Organization ID:&nbsp;</font></td><td><input type="text" name="organization_id" style="color: #919191; padding-left:3; width:260px;">&nbsp;&nbsp;</td></tr>
					<tr><td align="right"><font style="font-size: 12pt">Location ID:&nbsp;</font></td><td><input type="text" name="location_id" style="color: #919191; padding-left:3; width:260px;">&nbsp;&nbsp;</td></tr>
					<tr><td align="right"><font style="font-size: 12pt">API Access ID:&nbsp;</font></td><td><input type="text" name="api_access_id" style="color: #919191; padding-left:3; width:260px;">&nbsp;&nbsp;</td></tr>
					<tr><td align="right"><font style="font-size: 12pt">API Secure Key:&nbsp;</font></td><td><input type="text" name="api_secure_key" style="color: #919191; padding-left:3; width:260px;">&nbsp;&nbsp;</td></tr>
				</table>
				<table border="0" cellspacing="0" width="370">
					<tr><td align="right"><span style="font-size: 8pt">&nbsp;</span></td></tr>
					<tr><td align="right"><p style="font-size:12pt; text-align:justify">This script uses REST calls to create a list of all the credit cards that were updated by Account Updater.</td></tr>
				...
				<table border="0" cellpadding="1" cellspacing="0">
					...
					<tr><td colspan="2"><span style="font-size: 24pt">&nbsp;</span></td></tr>
				</table>
				<table width="370" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr><td><p align="justify"><span style="font-size: 11pt; color:#000088;"><b>Disclaimer: </b>This report generator is a personal project and is not supported by or guaranteed by Forte Payment Systems.</p></span></td></tr>
				</table>
			</center>
			</td>
			</tr>
