...
$fail_custLog = fopen("../../../internal-toolbox/importer/failure.log2.cust-CC.txt", "a+");
fwrite($fail_custLog, "
////////////////////////////////////////////////////////////////
///////////                                         ////////////
...
if ($handle = fopen("../../../internal-toolbox/importer/failure.CC.customer.data.csv", "r")) {
	while ($fields = fgetcsv($handle)) {
		...
		$fail_custData = fopen("../../../internal-toolbox/importer/failure.data2.cust-CC.csv", "a+");
		...
		if($info['http_code']==201) {
			...
			$fp = file('../../../internal-toolbox/importer/failure.CC.schedule.data.csv');
			$error_no2 = count($fp);
...
rename("../../../internal-toolbox/importer/failure.data2.cust-CC.csv","../../../internal-toolbox/importer/failure.CC.customer.data.csv");
rename("../../../internal-toolbox/importer/failure.log2.cust-CC.txt","../../../internal-toolbox/importer/failure.CC.customer.log.txt");
