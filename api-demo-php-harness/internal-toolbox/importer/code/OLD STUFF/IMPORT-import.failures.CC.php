...
if (!file_exists("../../../toolbox1/importer/failure.CC.data.csv")) {
...
if ($handle = fopen("../../../toolbox1/importer/failure.CC.data.csv", "r")) {
	while ($fields = fgetcsv($handle, 1000, ",")) {
		...
		if (!file_exists('../../../toolbox1/importer/failure.log2.CC.txt')) {
			$fail_log = fopen("../../../toolbox1/importer/failure.log2.CC.txt", "a+");
			fwrite($fail_log, "
////////////////////////////////////////////////////////////////
////////////////////                       /////////////////////
////////////////////   C C   E R R O R S   /////////////////////
...
");
		...
		$fail_data = fopen("../../../toolbox1/importer/failure.data2.CC.csv", "a+");
...
rename("../../../toolbox1/importer/failure.data2.CC.csv","../../../toolbox1/importer/failure.CC.data.csv");
rename("../../../toolbox1/importer/failure.log2.CC.txt","../../../toolbox1/importer/failure.CC.log.txt");
?>