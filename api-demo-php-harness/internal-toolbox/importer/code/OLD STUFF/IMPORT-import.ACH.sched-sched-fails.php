...
$fail_schedLog = fopen("../../../internal-toolbox/importer/failure.log2.sched-ACH.txt", "a+");
...
if ($handle = fopen("../../../internal-toolbox/importer/failure.ACH.schedule.data.csv", "a+")) {
	while ($fields = fgetcsv($handle)) {
		...
		$fail_schedData = fopen("../../../internal-toolbox/importer/failure.data2.sched-ACH.csv", "a+");
